...
// Import seed data
import applicationsData from "./seedData/application.json" assert { type: "json" };
import leasesData from "./seedData/lease.json" assert { type: "json" };
import locationsData from "./seedData/location.json" assert { type: "json" };
import managersData from "./seedData/manager.json" assert { type: "json" };
import paymentsData from "./seedData/payment.json" assert { type: "json" };
import propertiesData from "./seedData/property.json" assert { type: "json" };
import tenantsData from "./seedData/tenant.json" assert { type: "json" };
...
async function seedDatabase() {
  ...
  try {
    ...
    const locationValues = locationsData.map(l => {
        const [longitude, latitude] = l.coordinates.match(/POINT\((.*)\)/)[1].split(' ');
